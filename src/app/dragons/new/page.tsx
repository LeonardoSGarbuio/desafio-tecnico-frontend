...
import { ArrowLeft, Plus, Sparkles, Upload, X, ImageIcon } from "lucide-react";
import { toast } from "sonner";
import { createDragon } from "@/services/dragon-api";
...
export default function NewDragonPage() {
  ...
  // Função para processar arquivo de imagem e otimizar para preview/armazenamento
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      // Redimensiona caso seja muito pesada via Canvas
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Dragão "${name.trim()}" catalogado com sucesso!`);
      router.push("/dragons");
    } catch {
      toast.error("Falha ao cadastrar o dragão. Tente novamente.");
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-[#050505]">
      ...
      {/* Card de Formulário com Efeito Vidro Clean */}
      <div
      ...
      >
        <div className="mb-6">
          ...
          <p className="text-xs text-white/75 mt-1">
            Preencha os detalhes do espécime ancestral e anexe sua fotografia.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Alduin, Smaug, Drogon..."
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Gelo Glacial, Chamas Solares, Tempestade..."
              className="w-full h-11 px-4 text-sm rounded-xl text-white placeholder:text-white/45 focus:outline-none focus:border-emerald-400 transition-all"
              style={{
                background: "rgba(255, 255, 255, 0.07)",
                border: "1px solid rgba(255, 255, 255, 0.3)",
          ...
          {/* Botão de Criação em Degradê Verde */}
          <button
            type="submit"
